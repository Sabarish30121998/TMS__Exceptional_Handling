...
public class VehicleTypeController {
    ...
    public ApiRes create1(@RequestBody VehicleTypeDTO vehicleTypeDTO)
    {
        ApiRes apiRes = null;
        apiRes=ApiRes.builder().Data(vehicleTypeServiceInterface.create(vehicleTypeDTO)).build();
        return apiRes;
//        return vehicleTypeServiceInterface.create(vehicleTypeDTO);
    ...
    @GetMapping("/testapi")
    @RolesAllowed(value = "user")
    public BaseResponse test(@RequestParam long num)
    {
        BaseResponse baseResponse = new BaseResponse();
        Long div = 100/num;
        baseResponse.setData(div);
        return baseResponse;
    }
}
