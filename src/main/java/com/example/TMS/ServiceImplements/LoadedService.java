...
public class LoadedService implements LoadedServiceInterface {
    ...
    public BaseResponse getbyid(long id) {
        ...
        if(sabari.isPresent())
        {
            ...
            {
                throw  new ObjectRemovedException("The Requested LoadedID is Deleted");
            }

        }
        else
        {
            throw  new UsernameNotFoundException("Please give a valid Loaded ID");
        }
    ...
    public BaseResponse deletebyid(long id) {
        ...
        {
            throw  new UsernameNotFoundException("Please enter the valid loaded id to delete");
        }
        return  baseResponse;
    }
    ...
    public BaseResponse putupdate(LoadedDTO loadedDTO, Long id) {
        ...
        {
            throw  new UsernameNotFoundException("Please enter a valid Loaded id");
        }
