...
public class VehicleTypeService implements VehicleTypeServiceInterface {
    ...
    @Override
    public VehicleType create(VehicleTypeDTO vehicleTypeDTO) {
...
//        return baseResponse;
    ...
    public BaseResponse getbyid(long id) {
        ...
        if(sabari.isPresent())
        {
           ...
           {
               throw  new ObjectRemovedException("This VehicleType ID is Deleted");
           }
        }
        else {
    ...
    public BaseResponse deletebyid(long id) {
        ...
        {
            throw  new UsernameNotFoundException("Please enter the valid vehicle type id to delete");
        }
        return baseResponse;
    }
    ...
    public BaseResponse putupdate(VehicleTypeDTO vehicleTypeDTO, Long id) {
        ...
        {
            throw new UsernameNotFoundException("Enter A Valid UserId");
        }
