...
import com.example.TMS.common.ObjectRemovedException;
...
public class VehicleService implements VehicleServiceInterface {
    ...
    public BaseResponse create(VehicleDTO vehicleDTO) {
        ...
        {
            throw  new UsernameNotFoundException("enter a valid vehicletype id");
        }
        ...
        vehicleDTO.getUserDTOidmapping().forEach(user ->{
            ...
            {
                throw  new UsernameNotFoundException("Please enter a valid user id");
            }
    ...
    public BaseResponse deletebyid(long id) {
        ...
        {
            throw  new UsernameNotFoundException("Please Enter the Valid Vehicle id to delete");
        }
    ...
    public BaseResponse getbyid(long id) {
        ...
        if(sabari.isPresent())
        {
            ...
            {
                throw  new ObjectRemovedException("This Vehicle Id is Deleted");
            }
        }
        else
        {
            throw  new UsernameNotFoundException(" Please enter the valid vehicle id ");
        }
        return  baseResponse;
    }
    ...
    public BaseResponse putupdate(long id, VehicleDTO vehicleDTO) {
        ...
        {
            throw  new UsernameNotFoundException("please enter a valid vehicle id ");
        }
